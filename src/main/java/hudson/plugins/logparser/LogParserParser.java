...
public class LogParserParser {
    ...
    public LogParserParser(final FilePath parsingRulesFile,
        ...
        statusCount.put(LogParserConsts.RECOMMEND,0);
    ...
    public LogParserResult parseLog(final Run<?, ?> build) throws IOException, InterruptedException {
        ...
        final String recommendLinksFilePath = logDirectory + "/logrecommendLinks.html";
        ...
        linkFiles.put(LogParserConsts.RECOMMEND,recommendLinksFilePath);
        ...
        writers.put(LogParserConsts.INFO, new BufferedWriter(new FileWriter(
                infoLinksFilePath)));
        writers.put(LogParserConsts.RECOMMEND, new BufferedWriter(new FileWriter(
                recommendLinksFilePath)));
        ...
        ((BufferedWriter) writers.get(LogParserConsts.RECOMMEND)).close();
...
//        result.setTotalInfos((Integer) statusCount.get(LogParserConsts.RECOMMEND));
