...
public class LogParserDisplayConsts {
    ...
    public LogParserDisplayConsts() {
        ...
        colorTable.put(LogParserConsts.RECOMMEND, "blue");
        ...
        iconTable.put(LogParserConsts.RECOMMEND, "blue.gif");
        ...
        linkListDisplay.put(LogParserConsts.RECOMMEND, "Recommends");
        ...
        linkListDisplayPlural.put(LogParserConsts.RECOMMEND, "Recommends");
    }
